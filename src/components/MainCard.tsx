    ...
    return (
      <Card
        ...
        sx={{
          ...
          borderRadius: 1,
          borderColor: '#fafafa', // theme.palette.mode === 'dark' ? theme.palette.divider : theme.palette.grey["800"],
          // boxShadow: boxShadow && (!border || theme.palette.mode === 'dark') ? shadow || theme.customShadows.z1 : 'inherit',
          ':hover': {
            boxShadow: 'inherit' // boxShadow, // ? shadow || theme.customShadows.z1 : 'inherit'
          },
          ...(codeHighlight && {
            '& pre': {
              m: 0,
